...
// NOTE: DID NOT GET ACCEPTED WITH C++
/*
	getting correct answers for sample test cases, but it says "wrong answer"
	also unlock tests 2,3,9 getting correct results but not accepted -> check back later
	
	worked with python code.. exactly equivalent changes
